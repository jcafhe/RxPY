...
new_thread_scheduler = rx.scheduler.NewThreadScheduler()
...
class MainFrame(QFrame):
    def __init__(self):
        ...
        def produce_coordinates(*args):
            coordinates = rx.interval(period).pipe(
        ...
        disposable = trig.pipe(
            ...
            ops.switch_latest(),
            ops.observe_on(QtThreadSafeScheduler(QtCore)),
